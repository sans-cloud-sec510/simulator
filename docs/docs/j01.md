...
- Follow the **Lab 1.0: Cloud Account Setup** instructions in the electronic workbook to configure the Google Cloud Command Line Interface (CLI) and set up your Firebase project.
